                    ...
                    <form method="post" action="">
                        ...
                        <div class="form-group row">
                            <div class="col-md-2"><label for="InputNormal" class="form-control-label">Kode
                                    kelurahan</label></div>
                            <div class="col-md-10"><input type="text" name="kode_kelurahan" class="form-control"
                                    id="InputNormal" value="{{ $Kelurahan->kode_kelurahan }}"
                                    placeholder="Kode Kelurahan"></div>
                        </div>

                        <div class="form-group row">
                            <div class="col-md-2"><label for="InputNormal" class="form-control-label">Nama
                                    kelurahan</label></div>
                            <div class="col-md-10"><input type="text" name="kelurahan" class="form-control"
                                    id="InputNormal" value="{{ $Kelurahan->kelurahan }}" placeholder="Kelurahan"></div>
                        </div>
                        <div class="form-group row">
                            <div class="col-md-2"><label for="InputNormal" class="form-control-label">Nama
                                    Kecamatan</label></div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-10"> <select class="form-control" id="exampleSelect1"
                                    ...
                                    <option value="{{ $j->id}}"
                                        {{ $Kelurahan->kecamatan_id == $j->id ? 'selected' : ''}}>{{$j->kecamatan}}
                                    </option>
                                    @endforeach
                                </select></div>
                        </div>
