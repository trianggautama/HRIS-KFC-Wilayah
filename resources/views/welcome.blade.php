...
<head>
    <title>KFC &mdash; Kalimantan Selatan</title>
    <meta charset="utf-8">
    ...
    <link rel="stylesheet" href="{{asset('depan/fonts/icomoon/style.css')}}">
    ...
    <link rel="stylesheet" href="{{asset('depan/fonts/flaticon/font/flaticon.css')}}">
...
<body data-spy="scroll" data-target=".site-navbar-target" data-offset="200">
        ...
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-11 col-xl-2 site-logo">
                    <h1 class="mb-0"><a href="index.html" class="text-white h2 mb-0">KFC</a></h1>
                </div>
            ...
            <div class="row align-items-center justify-content-center text-center">
                ...
                <div class="col-md-8" data-aos="fade-up" data-aos-delay="400">
                    ...
                    <h1 class="text-white font-weight-light text-uppercase font-weight-bold" data-aos="fade-up">
                        Pengelolaan Sumber Daya Manusia</h1>
                    <p class="mb-5" data-aos="fade-up" data-aos-delay="100">pada KFC Wilayah Kalimantan Selatan</p>
                    <p data-aos="fade-up" data-aos-delay="200"><a href="{{route('login')}}"
                            class="btn btn-primary py-3 px-5 text-white">Mulai!</a></p>
        ...
        <div class="container">
            <div class="row mb-5">
                ...
                <div class="col-md-5 ml-auto mb-5 order-md-2" data-aos="fade-up" data-aos-delay="100">
                    <img src="images/side.jpg" alt="Image" class="img-fluid rounded">
                </div>
                <div class="col-md-6 order-md-1" data-aos="fade-up">
                    <div class="text-left pb-1 border-primary mb-4">
                        <h2 class="text-primary">Tentang Aplikasi</h2>
                    </div>
                    <p>Aplikasi ini digunakan untuk mempermudah setiap Outlet KFC yang ada di kalimantan selatan dalam
                        mengelola Sumber daya manusianya </p>
                    <p class="mb-5">, dimana data akan terintegrasi langung oleh kantor KFC Wilayah Kalimantan Selatan.
                        berikut adalah fitur dari aplikasi ini antara lain :</p>

                    <ul class="ul-check list-unstyled success">
                        <li>Pengelolaan data Pegawai Secara Langsung</li>
                        <li>Fitur Penilaian Kinerja Karyawan</li>
                        <li>Pengumuman hasil Penilaian Setiap Outlet</li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row justify-content-center mb-5" data-aos="fade-up">
                <div class="col-md-7 text-center border-primary">
                    <h2 class="mb-0 text-primary">Tujuan </h2>
                    <p class="color-black-opacity-5">Pembuatan Aplikasi</p>
                </div>
            </div>
                ...
                <div class="col-md-9">
                    <div class="row">
                        <div class="col-md-5 mr-auto">
                            ...
                            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Aperiam iure deserunt ut
                                architecto dolores quo beatae laborum aliquam ipsam rem impedit obcaecati ea
                                consequatur.</p>
                        </div>
                    ...
                    <div class="border-top pt-5">
                        <p>
                            <small class="block">&copy; <script>
                                ...
                                </script> Logis Free Template. All Rights Reserved. <br> Designed &amp; Developed by <a
    ...
    <script src="{{asset('depan/js/jquery-ui.js')}}"></script>
    ...
    <script src="{{asset('depan/js/bootstrap-datepicker.min.js')}}"></script>
