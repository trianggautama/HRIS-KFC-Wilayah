      ...
      <div class="container">
        <div class="row mb-5">
          ...
          <div class="col-md-6 order-md-1" data-aos="fade-up">
            ...
            <p>Aplikasi ini digunakan untuk mempermudah setiap Outlet KFC yang ada di kalimantan selatan dalam mengelola Sumber daya manusianya  </p>
            <p class="mb-5">, dimana data akan terintegrasi langung oleh kantor KFC Wilayah Kalimantan Selatan. berikut adalah fitur dari aplikasi ini antara lain :</p>
